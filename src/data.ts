type Product = {
  ...
  export const pastas: Products = [
    {
      id: 1,
      title: "Penne Pasta",
      desc: "classic Italian dish made with al dente penne pasta, tossed in a rich and flavorful tomato sauce.",
      img: "/temporary/p4.png",
      price: 24.9,
      options: [
        {
    ...
    },
    {
      id: 2,
      title: "Fusilli Pasta",
      desc: "classic Italian dish made with al dente fusilli pasta, tossed in a rich and flavorful tomato sauce.",
      img: "/temporary/p7.png",
      price: 32.9,
      options: [
        {
  ...
  export const burgers: Products = [
    {
      id: 1,
      title: "Beef Burger",
      desc: "topped with crispy lettuce, juicy tomato slices,melted cheese, crispy bacon, sautéed mushrooms, caramelized onions and crunchy pickles.",
      img: "/temporary/p2.png",
      price: 24.9,
      options: [
        {
    ...
    },
    {
      ...
      desc: "topped with crisp lettuce, ripe tomato slices, and tangy pickles,melted cheese, crispy bacon, and spicy jalapenos.",
      img: "/temporary/p5.png",
      price: 32.9,
      options: [
        {
...

    {
      id: 3,
      title: "Cheesy Burger",
      desc: "Topped with ooey-gooey melted cheese, crisp lettuce, juicy tomato slices, and tangy pickles.",
      img: "/temporary/p9.png",
      price: 32.9,
      options: [
        {
  ...
  export const menu: Menu = [
    ...
    },
    {
      ...
      slug: "burgers",
      title: "Juicy Burgers",
      desc: "Burger Bliss: Juicy patties, bold flavors, and tasty gourmet toppings galore.",
